...
class LoanedBookInstancesByUserListViewTest(TestCase):
    ...
    def test_only_borrowed_books_in_list(self):
        ...
        for bookitem in response.context['bookinstance_list']:
            ...
            self.assertEqual(bookitem.status, 'b')
...
class RenewBookInstancesViewTest(TestCase):
    ...
    def test_redirects_to_all_borrowed_book_list_on_success(self):
        ...
        self.assertRedirects(response, reverse('all-borrowed2'))
...
class AuthorCreateViewTest(TestCase):
    ...
    def test_logged_in_with_permission_add_author(self):
        ...
        # Check that user with right permission could access page.
        self.assertEqual(response.status_code, 200)
    ...
    def test_view_redirect_on_success(self):
        ...
        print(self.test_author.pk, self.test_author.first_name, self.test_author.last_name )

        login = self.client.login(username='test_user', password='some_password')
        response = self.client.post(reverse('author-create'), {"first_name": self.test_author.first_name , 'last_name': self.test_author.last_name})
        ...
        self.assertRedirects(response, reverse('author-detail', kwargs={'pk': self.test_author.pk + 1}))
